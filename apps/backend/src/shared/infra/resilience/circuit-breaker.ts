 ...
 *
 * Note: This class does NOT use @Injectable() decorator because it's always
 * created via factory providers with custom options. Each module that needs
 * a circuit breaker should provide it via useFactory.
 *
 * Requirements: 6.4
 */
